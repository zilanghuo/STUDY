 ...
 */
@Slf4j
@Service(value = "blueSendSmService")
public class BlueSendSmService extends AbstractBlueSmService implements ISendSmService, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        executor = new ThreadPoolExecutor(100, 2000, 200L, TimeUnit.MINUTES, new LinkedBlockingQueue<Runnable>(),
                new SmThirdProviderThreadFactory("BlueSendSmService-pool-"));
    }

    @Override
    public MessageResultDto<SendSmCommonRspDto> sendSm(SendSmCommonReqDto sendSmCommonReqDto) {
        blueSendMessage(SmChannelConfig.BLUE_MARKET, sendSmCommonReqDto, SendSmType.MARKET, executor);
