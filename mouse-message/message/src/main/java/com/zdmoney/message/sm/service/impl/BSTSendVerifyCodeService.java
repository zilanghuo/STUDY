 ...
 */
@Slf4j
@Service(value = "bstSendVerifyCodeService")
public class BSTSendVerifyCodeService extends AbstractBstSmService implements ISendSmService, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        executor = new ThreadPoolExecutor(50, 500, 100L, TimeUnit.MINUTES, new LinkedBlockingQueue<Runnable>(),
                new SmThirdProviderThreadFactory("BSTSendVerifyCodeService-pool-"));
    }
    ...
    public MessageResultDto<SendSmCommonRspDto> sendSm(SendSmCommonReqDto sendSmCommonReqDto) {
        ...
        bstSendMessage(SmChannelConfig.BST_MSG, sendSmCommonReqDto, SendSmType.VERIFY, executor);
