...
import com.zdmoney.mq.client.consumer.listener.MqMessageWrapper;
...
public class MqConsumer implements InitializingBean, DisposableBean {
    ...
    public void init() {
        ...
        try {
            ...
            consumer.registerMessageListener(new MqMessageWrapper(this.mqMessageListener));
            consumer.start();
    ...
    private void validate() {
        ...
        if (this.mqMessageListener == null) {
            throw new MqConfigException("not set mqMessageListener for consumer");
        }
